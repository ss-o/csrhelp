...
(function (F, x, Oa) {
  ...
  function R(a, b, c) {
    ...
    c.preparationClasses &&
      ((b.preparationClasses = $(c.preparationClasses, b.preparationClasses)),
  ...
  var L = x.noop,
    ...
    W,
    ta;
  pa(F.ontransitionend) && qa(F.onwebkittransitionend)
    ? ((N = "WebkitTransition"), (sa = "webkitTransitionEnd transitionend"))
    : ((N = "transition"), (sa = "transitionend"));
  pa(F.onanimationend) && qa(F.onwebkitanimationend)
    ? ((W = "WebkitAnimation"), (ta = "webkitAnimationEnd animationend"))
    : ((W = "animation"), (ta = "animationend"));
  var ka = W + "Delay",
    ua = W + "Duration",
    ga = N + "Delay";
  F = N + "Duration";
          ...
          function (d, y, v, z, l, s, O, x, t, la, E) {
            ...
            function p(a, b, c) {
              ...
              for ((a = a.data("$ngAnimatePin")) && (b = a); b && b.length; ) {
                ...
                if (pa(d) || !0 === d)
                  (a = b.data("$$ngAnimateChildren")), qa(a) && (d = a);
                if (f && !1 === d) break;
                g ||
                  ((g = B(b, v)),
              ...
              function S(a) {
                ...
                q(c, function (c, e) {
                  ...
                  if (h && r) {
                    ...
                    (h = h ? h.animationID : r.animationID),
                      (r = h.toString()),
                      d[r] || ((d[r] = !0), b.push(a[h]));
                });
                return b;
              }
              function u(a, b) {
          ...
          function (a, e, y, v, z, l, s, O) {
            ...
            return function (a, c) {
              ...
              0 <= c.duration &&
                ...
                w.push(C));
              c.keyframeStyle &&
                ((C = [W, c.keyframeStyle]), fa(g, C), w.push(C));
              var Z = T
                ? 0 <= c.staggerIndex
                  ? c.staggerIndex
                  : b.count(ba)
              ...
              n.applyTransitionDelay =
                na(c.delay) && (n.applyTransitionDuration || n.hasTransitions);
