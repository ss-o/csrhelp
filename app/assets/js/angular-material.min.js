...
!(function (e, t, n) {
  ...
  !(function () {
          ...
          f = {
            ...
            disableScrollAround: function (e, n) {
              function r(e) {
                ...
                var i = 50,
                  a = t.element(
                    '<div class="md-scroll-mask" style="z-index: ' +
                      i +
                      '">  <div class="md-scroll-mask-bar"></div></div>',
                  );
                return (
                  e.appendChild(a[0]),
                  a.on("wheel", r),
                  ...
                  function () {
                    a.off("wheel"),
                      ...
                      o.off("keydown", n),
                      delete f.disableScrollAround._enableScrolling;
                  }
                );
              }
              function i() {
                ...
                return (
                  d.scrollHeight > d.clientHeight &&
                    (a(d, { position: "fixed", width: "100%", top: -o + "px" }),
                    a(e, { overflowY: "scroll" })),
                  d.clientWidth < r && a(d, { overflow: "hidden" }),
                  function () {
              ...
              if (
                ...
                ++f.disableScrollAround._count,
                f.disableScrollAround._enableScrolling)
              )
                return f.disableScrollAround._enableScrolling;
              e = t.element(e);
              var d = o[0].body,
                c = i(),
                s = r(n);
              return (f.disableScrollAround._enableScrolling = function () {
                --f.disableScrollAround._count ||
                  (c(), s(), delete f.disableScrollAround._enableScrolling);
              });
            },
            ...
            validateScope: function (e) {
              ...
              return (
                n ||
                  l.warn(
                    "element.scope() is not available when 'debug mode' == false. @see https://docs.angularjs.org/guide/production!",
                  ),
                n
              );
            },
      ...
      function e(e, n, o, r, i, a) {
        this.compile = function (d) {
          ...
          return (
            ...
            t.extend(u, h),
            c
              ? (u.$template = n.get(c, { cache: a }).then(function (e) {
                  return e.data;
                }))
              : (u.$template = e.when(s)),
        ...
        function e(e) {
          ...
          function i(n, o) {
            ...
            var s,
              l,
              m = n(),
              u = { hide: m.hide, cancel: m.cancel, show: r, destroy: i };
            return (
              (s = c.methods || []),
          ...
          var a = ["onHide", "onShow", "onRemove"],
            d = {},
            c = { presets: {} },
            s = { setDefaults: n, addPreset: r, addMethod: o, $get: i };
          return (
            s.addPreset("build", {
              methods: [
                "controller",
        ...
        function o(e, o, r, i, a, d, c, s, l, m, u) {
          return function () {
            ...
            function h(e, t) {
              function r(n) {
                return (
                  n.remove(e || v, !1, t || {})["catch"](function (e) {
                    return e;
                  }),
                  n.deferred.promise
                );
            ...
            function p(e, t) {
              var n = M.shift();
              return n
                ? (n.remove(e || E, !0, t || {})["catch"](function (e) {
                    return e;
                  }),
                  n.deferred.promise)
                : o.when(e || E);
            ...
            function g(u) {
              ...
              function E(e, n) {
                ...
                return (
                  (n.element = o), (n.parent = v(o, n)), n.themable && m(o), o
                );
              }
              function v(n, o) {
                var r = o.parent;
                if (
                  ...
                  return (
                    d[0] &&
                      d[0].querySelector &&
                      (i = d[0].querySelector(":not(svg) > body")),
                    i || (i = d[0]),
              ...
              return (
                (u = f(u)),
                (A = { options: u, deferred: o.defer(), show: h, remove: p })
              );
            }
            var b,
              E = !1,
    ...
    (function () {
      !(function () {
              ...
              t.forEach(s, function (t) {
                if (e === "layout" + t) {
                  var s = o(r, "md-layout" + t, i),
                    ...
                    u = m ? !n(m) : !1,
                    h = n(m);
                  u && r.addClass(a.supplant("md-layout{0}-{1}", [t, m])),
                    h && i.$observe(l, s),
                    d.removeAttributes && r.removeAttr(e),
                    (c = !0);
                }
              }),
              c
        ...
        function o(e, t, n) {
          ...
          return function (n) {
            ...
            e.removeClass(o),
              (o = r ? t + "-" + r : t),
              e.addClass(o),
              d.removeAttributes && e.removeAttr(t);
          };
        }
        function r(e) {
          function t(t, n) {
        ...
        t.module("material.core.layout", ["ng"])
          ...
          .directive("layout", e("layout"))
          .directive("layoutSm", e("layout-sm"))
          .directive("layoutGtSm", e("layout-gt-sm"))
          .directive("layoutMd", e("layout-md"))
          .directive("layoutGtMd", e("layout-gt-md"))
          .directive("layoutLg", e("layout-lg"))
          .directive("layoutGtLg", e("layout-gt-lg"))
          .directive("flex", e("flex"))
          .directive("flexSm", e("flex-sm"))
          .directive("flexGtSm", e("flex-gt-sm"))
          .directive("flexMd", e("flex-md"))
          .directive("flexGtMd", e("flex-gt-md"))
          .directive("flexLg", e("flex-lg"))
          .directive("flexGtLg", e("flex-gt-lg"))
          .directive("layoutAlign", e("layout-align"))
          .directive("layoutAlignSm", e("layout-align-sm"))
          .directive("layoutAlignGtSm", e("layout-align-gt-sm"))
          .directive("layoutAlignMd", e("layout-align-md"))
          .directive("layoutAlignGtMd", e("layout-align-gt-md"))
          .directive("layoutAlignLg", e("layout-align-lg"))
          .directive("layoutAlignGtLg", e("layout-align-gt-lg"))
          .directive("flexOrder", e("flex-order"))
          .directive("flexOrderSm", e("flex-order-sm"))
          .directive("flexOrderGtSm", e("flex-order-gt-sm"))
          .directive("flexOrderMd", e("flex-order-md"))
          .directive("flexOrderGtMd", e("flex-order-gt-md"))
          .directive("flexOrderLg", e("flex-order-lg"))
          .directive("flexOrderGtLg", e("flex-order-gt-lg"))
          .directive("offset", e("offset"))
          .directive("offsetSm", e("offset-sm"))
          .directive("offsetGtSm", e("offset-gt-sm"))
          .directive("offsetMd", e("offset-md"))
          .directive("offsetGtMd", e("offset-gt-md"))
          .directive("offsetLg", e("offset-lg"))
          .directive("offsetGtLg", e("offset-gt-lg"))
          .directive("layoutMargin", r("layout-margin"))
          .directive("layoutPadding", r("layout-padding"))
          .directive("layoutWrap", r("layout-wrap"))
          .directive("layoutFill", r("layout-fill"))
          .directive("hide", r("hide"))
          .directive("hideSm", r("hide-sm"))
          .directive("hideGtSm", r("hide-gt-sm"))
          .directive("hideMd", r("hide-md"))
          .directive("hideGtMd", r("hide-gt-md"))
          .directive("hideLg", r("hide-lg"))
          .directive("hideGtLg", r("hide-gt-lg"))
          .directive("show", r("show"))
          .directive("showSm", r("show-sm"))
          .directive("showGtSm", r("show-gt-sm"))
          .directive("showMd", r("show-md"))
          .directive("showGtMd", r("show-gt-md"))
          .directive("showLg", r("show-lg"))
          .directive("showGtLg", r("show-gt-lg"))
          .directive("layoutLtMd", i("layout-lt-md", !0))
          .directive("layoutLtLg", i("layout-lt-lg", !0))
          .directive("flexLtMd", i("flex-lt-md", !0))
          .directive("flexLtLg", i("flex-lt-lg", !0))
          .directive("layoutAlignLtMd", i("layout-align-lt-md"))
          .directive("layoutAlignLtLg", i("layout-align-lt-lg"))
          .directive("flexOrderLtMd", i("flex-order-lt-md"))
          .directive("flexOrderLtLg", i("flex-order-lt-lg"))
          .directive("offsetLtMd", i("offset-lt-md"))
          .directive("offsetLtLg", i("offset-lt-lg"))
          .directive("hideLtMd", i("hide-lt-md"))
          .directive("hideLtLg", i("hide-lt-lg"))
          .directive("showLtMd", i("show-lt-md"))
          .directive("showLtLg", i("show-lt-lg"));
      })();
    })(),
    (function () {
      function e(e, n) {
    ...
    (function () {
      ...
      function n(e) {
        function n(n, r, i) {
          return r.controller("mdNoInk")
            ? t.noop
            : e.instantiate(o, { $scope: n, $element: r, rippleOptions: i });
        }
        return { attach: n };
      }
      function o(e, n, o, r, i, a) {
        (this.$window = r),
          ...
          a.valueOnUse(this, "color", this.getColor, 1),
          a.valueOnUse(this, "background", this.getColor, 0.5),
      ...
      (e.$inject = ["$mdButtonInkRipple", "$mdCheckboxInkRipple"]),
        ...
        (o.prototype.getColor = function (e) {
          function t() {
            var e = this.options.colorElement && this.options.colorElement[0];
            return (
              (e = e || this.$element[0]),
              e ? this.$window.getComputedStyle(e).color : "rgb(0,0,0)"
            );
          }
          function n(t) {
            function n(e) {
            ...
            if (t)
              return 0 === t.indexOf("rgba")
                ? t.replace(/\d?\.?\d*\s*\)\s*$/, (0.1 * e).toString() + ")")
                : 0 === t.indexOf("rgb")
                  ? o(t)
                  : 0 === t.indexOf("#")
                    ? n(t)
          ...
          return (
            (e = e || 1),
            n(this.$element.attr("md-ink-ripple")) || n(t.call(this))
          );
        }),
        ...
        (o.prototype.handleMousedown = function (e) {
          this.mousedown ||
            ...
            this.options.center
              ...
              : this.createRipple(e.layerX, e.layerY));
        }),
          ...
          if (this.isRippleAllowed()) {
            ...
            d.css({
              ...
              this.options.dimBackground &&
                this.container.css({ backgroundColor: this.background }),
    ...
    (function () {
        ...
        function c(e) {
          function n(e) {
            if (((e = 0 === arguments.length ? !0 : !!e), e !== o.isDark)) {
              (o.isDark = e),
                (o.foregroundPalette = o.isDark ? p : h),
                (o.foregroundShadow = o.isDark ? f : g);
              var n = o.isDark ? A : y,
                r = o.isDark ? y : A;
              return (
      ...
      function i(e, n, o) {
        ...
        var r = [],
          ...
          m =
            /'?"?\{\{\s*([a-zA-Z]+)-(A?\d+|hue\-[0-3]|shadow)-?(\d\.?\d*)?(contrast)?\s*\}\}'?"?/g,
          u = l[i.name];
        return (
          (o = o.replace(m, function (t, n, o, r, i) {
            return "foreground" === n
              ? "shadow" == o
                ? e.foregroundShadow
                : e.foregroundPalette[o] || e.foregroundPalette[1]
              : (0 === o.indexOf("hue") && (o = e.colors[n].hues[o]),
                s((l[e.colors[n].name][o] || "")[i ? "contrast" : "value"], r));
          })),
          t.forEach(i.hues, function (t, n) {
            ...
            "default" !== n &&
              ...
              "default" == e.name && (i = i.replace(/\.md-default-theme/g, "")),
              r.push(i);
          }),
          r
        );
      ...
      function e(e, n, o, r, i) {
        ...
        return (a = {
          translate3d: function (e, t, n, o) {
            ...
            return i(e, { from: t, to: n, addClass: o.transitionInClass })
              .start()
              .then(function () {
                return r;
              });
          ...
          waitTransitionEnd: function (e, t) {
            ...
            return n(function (n, a) {
              function d(t) {
                (t && t.target !== e[0]) ||
                  (t && o.cancel(c), e.off(r.CSS.TRANSITIONEND, d), n());
              }
              t = t || {};
          ...
          calculateZoomToOrigin: function (n, o) {
            var r = o.element,
              ...
              c = d({ centerX: 0, centerY: 0, scaleX: 0.5, scaleY: 0.5 });
            if (r) {
              ...
              c = d({
                ...
                centerY: u.y - m.y,
                scaleX:
                  Math.round(100 * Math.min(0.5, s.width / l.width)) / 100,
                scaleY:
                  Math.round(100 * Math.min(0.5, s.height / l.height)) / 100,
              });
            }
            return c;
          },
                ...
                function (t, d, c, s, l, m) {
                  function u(o, d) {
                    var s = [],
                      l = M(o);
                    d.transitionStyle &&
                      s.push([r + "transition", d.transitionStyle]),
                      d.keyframeStyle &&
                        s.push([r + "animation", d.keyframeStyle]),
                      d.delay &&
                        s.push([r + "transition-delay", d.delay + "s"]),
                      d.duration &&
                        s.push([r + "transition-duration", d.duration + "s"]);
                    var u =
                        d.keyframeStyle ||
                        ...
                        return (
                          g(function () {
                            ...
                            d.easing &&
                              ...
                              d.delay &&
                                c.animationDelay &&
                                u.push([r + "animation-delay", d.delay + "s"]),
                              d.duration &&
                                c.animationDuration &&
                                u.push([
                            ...
                            var f = c.delay,
                              ...
                              M = Date.now();
                            (A = []),
                              c.transitionDuration && A.push(i),
                              c.animationDuration && A.push(a),
                              (A = A.join(" ")),
                              (C = function (e) {
                                e.stopPropagation();
        ...
        function n(e, n, i, a, d, c, s) {
          function l(o, r, s, l) {
            (r = i.extractElementByName(r, "md-bottom-sheet")),
              (h = i.createBackdrop(o, "md-bottom-sheet-backdrop md-opaque")),
              h.on("click", function () {
                i.nextTick(d.cancel, !0);
              }),
              a.inherit(h, s.parent),
            ...
            return (
              ...
              s.disableParentScroll &&
                (s.restoreScroll = i.disableScrollAround(m.element, s.parent)),
            ...
            return (
              ...
              e.leave(i.element).then(function () {
                r.disableParentScroll &&
                  (r.restoreScroll(), delete r.restoreScroll),
                  i.cleanup(),
          ...
          function u(e, t) {
            ...
            return (
              t.on("$md.dragstart", a).on("$md.drag", c).on("$md.dragend", l),
              {
                element: e,
                cleanup: function () {
                  m(),
          ...
          return (
            ...
            function (d, s, l, m) {
              ...
              (m = m || i.fakeNgModel()),
                ...
                l.ngChecked &&
                  d.$watch(
                    d.$eval.bind(d, l.ngChecked),
                    m.$setViewValue.bind(m),
                  ),
                u("ngDisabled", "tabindex", { true: "-1", false: l.tabindex }),
                n.expectWithText(s, "aria-label"),
                e.link.pre(d, { on: t.noop, 0: {} }, l, [m]),
                (d.mouseActive = !1),
                s
                  .on("click", p)
                  .on("keypress", h)
    ...
    (function () {
      !(function () {
        function e() {
          return {
            template:
              ...
              (r - o) +
              '"><table role="grid" tabindex="0" class="md-calendar" aria-readonly="true"><tbody role="rowgroup" md-virtual-repeat="i in ctrl.items" md-calendar-month md-month-offset="$index" class="md-calendar-month" md-start-index="ctrl.getSelectedMonthIndex()" md-item-size="' +
              o +
        ...
        function n(e, t, n, o, r, i, a, c, s, l, m) {
          if (
            (a(e), (this.items = { length: 2e3 }), this.maxDate && this.minDate)
          ) {
          ...
          (this.cellClickHandler = function () {
            var e = this;
            this.hasAttribute("data-timestamp") &&
              n.$apply(function () {
        ...
        (n.$inject = [
          ...
          (n.prototype.handleKeyEvent = function (e) {
            ...
            this.$scope.$apply(function () {
              ...
              if (e.which === t.keyCode.ENTER)
                return (
                  t.setNgModelValue(t.displayDate), void e.preventDefault()
                );
              var n = t.getFocusDateFromKeyEvent(e);
              n &&
                ((n = t.boundDateByMinAndMax(n)),
                e.preventDefault(),
                e.stopPropagation(),
          ...
          (n.prototype.getFocusDateFromKeyEvent = function (e) {
            ...
            switch (e.which) {
              ...
              case n.DOWN_ARROW:
                return e.metaKey
                  ? t.incrementMonths(this.displayDate, 1)
                  : t.incrementDays(this.displayDate, 7);
              case n.UP_ARROW:
                return e.metaKey
                  ? t.incrementMonths(this.displayDate, -1)
                  : t.incrementDays(this.displayDate, -7);
          ...
          (n.prototype.changeDisplayDate = function (e) {
            if (!this.isInitialized)
              return this.buildInitialCalendarDisplay(), this.$q.when();
            if (
          ...
          (n.prototype.generateContent = function () {
            ...
            this.$element.empty(),
              ...
              this.focusAfterAppend &&
                (this.focusAfterAppend.classList.add(i),
          ...
          (n.prototype.buildDateCell = function (e) {
            ...
            if (
              ...
              n.setAttribute("tabindex", "-1"),
                ...
                this.dateUtil.isValidDate(t.selectedDate) &&
                  this.dateUtil.isSameDay(e, t.selectedDate) &&
                  (n.classList.add(r), n.setAttribute("aria-selected", "true"));
        ...
        t.module("material.components.datepicker").config([
          ...
          function (e) {
            ...
            (t.prototype.$get = function (e) {
              ...
              for (
                var d = e.DATETIME_FORMATS.DAY.map(function (e) {
                    return e[0];
                  }),
                  c = Array(32),
                  s = 1;
      ...
      !(function () {
        ...
        function o(e, n, o, r, i, a, d, c, s, l, m, u) {
          (this.$compile = r),
            ...
            (this.windowResizeHandler = s.debounce(
        ...
        (o.$inject = [
          ...
          (o.prototype.configureNgModel = function (e) {
            ...
            var t = this;
            e.$render = function () {
              (t.date = t.ngModelCtrl.$viewValue),
                (t.inputElement.value = t.dateLocale.formatDate(t.date)),
          ...
          (o.prototype.attachChangeListeners = function () {
            ...
            e.$scope.$on("md-calendar-change", function (t, n) {
              e.ngModelCtrl.$setViewValue(n),
                ...
                e.inputContainer.classList.remove(i);
            }),
              e.ngInputElement.on("input", t.bind(e, e.resizeInputElement)),
              e.ngInputElement.on(
                "input",
                e.$mdUtil.debounce(e.handleInputEvent, a, e),
              );
          }),
          (o.prototype.attachInteractionListeners = function () {
            ...
            e.ngInputElement.on("keydown", function (o) {
              o.altKey &&
                o.keyCode == n.DOWN_ARROW &&
                (e.openCalendarPane(o), t.$digest());
            }),
          ...
          (o.prototype.installPropertyInterceptors = function () {
            ...
            if (this.$attrs.ngDisabled) {
              var t = this.$mdUtil.validateScope(this.$element)
                ? this.$element.scope()
                : null;
              t &&
          ...
          (o.prototype.setErrorFlags = function () {
            this.dateUtil.isValidDate(this.date) &&
              ...
              "" === e
                ...
                : this.dateUtil.isValidDate(t) &&
                  ...
                  ? (this.ngModelCtrl.$setViewValue(t),
                    (this.date = t),
                    this.inputContainer.classList.remove(i))
                  : this.inputContainer.classList.toggle(i, e);
          }),
          (o.prototype.attachCalendarPane = function () {
            ...
            o + d > a &&
              a - d > i &&
              ((o = a - d), e.classList.add("md-datepicker-pos-adjusted")),
              (e.style.left = r + "px"),
              (e.style.top = o + "px"),
          ...
          link: function (r, i, a) {
            n(i),
              e(function () {
                ...
                var n,
                  a = i[0].querySelector("md-dialog-content");
                a &&
      ...
      function n(e) {
        ...
        function o(e, n, o, r, i, a, d, c) {
          function s(e, n, r, i) {
            ...
            return (
              t.element(a[0].body).addClass("md-dialog-is-showing"),
              c(),
              m(n, r),
              p(n.find("md-dialog"), r),
              h(e, n, r),
              b(n, r).then(function () {
                u(n, r), f(n, r), d();
              })
          ...
          function l(e, n, o) {
            ...
            function i() {
              t.element(a[0].body).removeClass("md-dialog-is-showing"),
                n.remove(),
          ...
          function m(e, n) {
            ...
            if (
              (o &&
                o.length &&
                ((n.origin.element = o),
                (n.origin.bounds = o[0].getBoundingClientRect()),
                (n.origin.focus = function () {
                  o.focus();
                })),
              t.isString(n.parent))
            ) {
          ...
          function h(e, t, n) {
            n.disableParentScroll &&
              (n.restoreScroll = o.disableScrollAround(t, n.parent)),
              n.hasBackdrop &&
                ((n.backdrop = o.createBackdrop(
                  e,
                  "md-dialog-backdrop md-opaque",
                )),
                i.enter(n.backdrop, n.parent)),
              (n.hideBackdrop = function (e) {
                n.backdrop && (e ? n.backdrop.remove() : i.leave(n.backdrop)),
                  n.disableParentScroll &&
          ...
          function p(e, t) {
            ...
            e.attr({ role: r, tabIndex: "-1" }),
              0 === i.length && (i = e),
              i.attr("id", a),
              e.attr("aria-describedby", a),
              t.ariaLabel
                ? n.expect(e, "aria-label", t.ariaLabel)
                : n.expectAsync(e, "aria-label", function () {
            ...
            function n(e) {
              for (; e.parentNode; ) {
                ...
                for (var t = e.parentNode.children, r = 0; r < t.length; r++)
                  e === t[r] ||
                    v(t[r], ["SCRIPT", "STYLE"]) ||
                    t[r].setAttribute("aria-hidden", o);
                n((e = e.parentNode));
              }
            }
            var o = !0;
          ...
          function g(e, t) {
            var n = "fixed" == d.getComputedStyle(a[0].body).position,
              ...
              i = r
                ? Math.min(
                    a[0].body.clientHeight,
                    Math.ceil(Math.abs(parseInt(r.height, 10))),
                  )
                : 0;
            return (
              e.css({
            ...
            return r.translate3d(n, d, c, a).then(function (e) {
              return (
                (t.reverseAnimate = function () {
                  return (
                    delete t.reverseAnimate, e(r.toTransformCss(i(n, t.origin)))
                  );
                }),
                !0
              );
    ...
    (function () {
      !(function () {
        ...
        t.module("material.components.fabActions", ["material.core"]).directive(
          "mdFabActions",
          e,
        );
      })();
      ...
      !(function () {
        function n(n, o, r, i, a) {
          ...
          function l(e) {
            ...
            do
              (o = e.map(function (e) {
                ...
                n ||
                  ((e = m(e)),
                  (r = e.length >= O.length && e.length !== o.length));
            while (10 > i && !n && r);
            return n;
          }
          function m(e) {
          ...
          function u(e) {
            return (
              O.push(e.type),
              l(["mousedown", "focusout?", "focusin?", "mouseup", "click"])
                ? (N(e), void s())
                : l(["touchstart?", "touchend?", "click"])
                  ? (N(e), void s())
                  : l(["focusin"])
                    ? (S.open(), void s())
                    : l(["focusout"])
          ...
          (S.open = function () {
            ...
            (S.close = function () {
              n.$evalAsync("vm.isOpen = false"),
                o.find("md-fab-trigger")[0].focus();
            }),
            (S.toggle = function () {
    ...
    (function () {
      !(function () {
        ...
        function r() {
          function e(e) {
            ...
            t.forEach(i, function (e, t) {
              var o = e.style,
                a = t * n;
              (o.opacity = r.isOpen ? 1 : 0),
                (o.transform = o.webkitTransform =
                  r.isOpen ? "scale(1)" : "scale(0)"),
                (o.transitionDelay = (r.isOpen ? a : i.length - a) + "ms");
            });
          }
          var n = 65;
          return {
        ...
        t.module("material.components.fabSpeedDial", [
          ...
          .animation(".md-scale", r)
          .service("mdFabSpeedDialFlingAnimation", o)
          .service("mdFabSpeedDialScaleAnimation", r);
      })();
    })(),
    (function () {
      !(function () {
        ...
        t.module("material.components.fabTrigger", ["material.core"]).directive(
          "mdFabTrigger",
          e,
        );
      })();
                ...
                (d.style.backgroundColor = u),
                  ...
                  a.isOpen
                    ...
                    : ((s.style.pointerEvents = "none"),
                      ...
                      (d.style.top = "0px"),
                      n.hasClass("md-right") &&
                        ((d.style.left = "0px"), (d.style.right = null)),
                      n.hasClass("md-left") &&
                        ((d.style.right = "0px"), (d.style.left = null)),
      ...
      function e(e, o, r, i) {
        function a(n, a, d, c) {
          ...
          function p(e, t, n, o, r, i, a) {
            ...
            switch (i) {
              case "fixed":
                (l.top = N({ unit: a, offset: e.row, gutter: r })),
              ...
              case "ratio":
                ...
                (l.paddingTop = _({ unit: u, span: t.row, gutter: r })),
                  (l.marginTop = N({ unit: u, offset: e.row, gutter: r }));
                break;
              case "fit":
                var h = (o - 1) / o,
                  m = (1 / o) * 100,
                  u = x({ share: m, gutterShare: h, gutter: r });
                (l.top = N({ unit: u, offset: e.row, gutter: r })),
    ...
    (function () {
        ...
        function r(r, i, a, d) {
          ...
          function l() {
            ...
            if (!t.isDefined(i.attr("md-no-autogrow"))) {
              ...
              h ? (h.$formatters.push(o), h.$viewChangeListeners.push(o)) : f(),
                i.on("keydown input", f),
                isNaN(u) && (i.attr("rows", "1"), i.on("scroll", c)),
      ...
      function r(e) {
        function n(n, o, r, i) {
          ...
          h ? t.element(h).prepend(l) : m.after(l),
            c.$formatters.push(a),
            ...
            n.$watch(r.mdMaxlength, function (n) {
              (d = n),
                t.isNumber(n) && n > 0
                  ? (l.parent().length || e.enter(l, s.element, m), a())
                  : e.leave(l);
            }),
          ...
          compile: function (a, d) {
            ...
            function s(n) {
              ...
              if ("div" == n)
                ...
                t.forEach(r, function (e) {
                  a[0].hasAttribute(e) &&
                    (o[0].setAttribute(e, a[0].getAttribute(e)),
                    a[0].removeAttribute(e));
                }),
              ...
              if (
                ...
                a.append(o),
                p && p.hasAttribute("ng-click"))
              ) {
                e.expect(p, "aria-label");
                var i = t.element(
                  '<md-button class="md-secondary-container md-icon-button">',
                );
                i.attr("ng-click", p.getAttribute("ng-click")),
                  p.removeAttribute("ng-click"),
                  p.setAttribute("tabindex", "-1"),
                  p.classList.remove("md-secondary"),
                  i.append(p),
                  (p = i[0]);
              }
              p &&
                (p.hasAttribute("ng-click") || (d.ngClick && l(p))) &&
                (a.addClass("md-with-secondary"), a.append(p));
            }
            function l(e) {
                  ...
                  (u &&
                    u.addEventListener("keypress", function (e) {
                      if (
                        ...
                        t == n.KEY_CODE.SPACE &&
                          u &&
                          (u.click(), e.preventDefault(), e.stopPropagation());
                      }
                    })),
                a.off("click"),
                a.off("keypress"),
            ...
            var u,
              h,
              p = a[0].querySelector(".md-secondary");
            if ((a[0].setAttribute("role", "listitem"), d.ngClick)) s("button");
              ...
              u
                ? s("div")
                : a[0].querySelector("md-button") || a.addClass("md-no-proxy");
            }
            return c(), m;
          },
        };
        ...
        function a(i, a, h) {
          ...
          function g() {
            if (t.isUndefined(h.mdMode)) {
              var e = t.isDefined(h.value),
                n = e ? m : u,
                i =
                  "Auto-adding the missing md-mode='{0}' to the ProgressCircular element";
          ...
          function b(e) {
            if (v()) {
              (C =
                C ||
                t.element(a[0].querySelector(".md-left > .md-half-circle"))),
                (T =
                  T ||
                  t.element(a[0].querySelector(".md-right > .md-half-circle"))),
                (k = k || t.element(a[0].querySelector(".md-gap")));
              var n = c({
                ...
                r = c({
                  ...
                  transform: o.supplant("rotate({0}deg)", [
                    50 >= e ? 135 : ((e - 50) / 50) * 180 + 135,
                  ]),
                }),
                i = c({
                  transition: e >= 50 ? "transform 0.1s linear" : "",
                  transform: o.supplant("rotate({0}deg)", [
                    e >= 50 ? 45 : (e / 50) * 180 - 135,
                  ]),
                });
    ...
    (function () {
      function e(e, o, r) {
        ...
        function a(i, a, u) {
          ...
          function g(e, n) {
            if (f()) {
              var r = o.supplant("translateX({0}%) scale({1},1)", [
                  (n - 100) / 2,
                  n / 100,
                ]),
                i = E({ transform: r });
    ...
    (function () {
      ...
      function n(e, t, n) {
        function o(o, i, a, d) {
          ...
          function l() {
            function e(e) {
              "MD-RADIO-GROUP" != i.parent()[0].nodeName &&
                i.parent()[e ? "addClass" : "removeClass"](r);
            }
            ...
            t !== u &&
              ...
              t
                ? (e(!0), i.addClass(r), d.setActiveDescendant(i.attr("id")))
                : (e(!1), i.removeClass(r)));
          }
          function m(n, o) {
            function r() {
    ...
    (function () {
      function e(e, o, r, i, a, d) {
        function c(c, s) {
          ...
          if (
            ...
            c.find("md-content").length ||
              c.append(t.element("<md-content>").append(c.contents())),
            s.mdOnOpen &&
              (c
                .find("md-content")
                .prepend(
              ...
              c.find("md-option").attr("ng-show", "$$loadingAsyncDone")),
            s.name)
          ) {
          ...
          var h = t.isDefined(s.multiple) ? "multiple" : "",
            p =
              '<div class="md-select-menu-container"><md-select-menu {0}>{1}</md-select-menu></div>';
          return (
            (p = o.supplant(p, [h, c.html()])),
            c.empty().append(l),
            (s.tabindex = s.tabindex || "0"),
            function (c, s, l, m) {
              function u() {
                ...
                !e && M && M.label && (e = M.label.text()),
                  i.expect(s, "aria-label", e);
              }
              function h() {
                w &&
                  ((N =
                    N || w.find("md-select-menu").controller("mdSelectMenu")),
                  $.setLabelText(N.selectedLabels()));
              }
              function f() {
                M &&
                  M.setHasValue(
                    N.selectedLabels().length > 0 ||
              ...
              function g() {
                ...
                if (
                  (e.data("$ngModelController", y),
                  e.data("$mdSelectController", $),
                  (x = c.$new()),
                  r.inherit(w, s),
                  s.attr("md-container-class"))
                ) {
                  var n =
                    w[0].getAttribute("class") +
                    " " +
                    s.attr("md-container-class");
              ...
              function b(e) {
                ...
                if (-1 != n.indexOf(e.keyCode)) e.preventDefault(), E(e);
                  ...
                  N.isMultiple || N.deselect(Object.keys(N.selected)[0]),
                    N.select(r.hashKey, r.value),
                    N.refreshViewValue(),
                    y.$render();
                }
              }
              ...
              if (M) {
                ...
                (M.input = s),
                  M.label || i.expect(s, "aria-label", s.attr("placeholder")),
                  c.$watch(k, M.setInvalid);
              }
              var w, x, N;
              if ((g(), r(s), l.name && A)) {
                var _ = s
              ...
              (y.$render = function () {
                ...
                l.$observe("placeholder", y.$render),
                ...
                ($.setIsPlaceholder = function (e) {
                  e
                    ? (C.addClass("md-select-placeholder"),
                      M &&
                        M.label &&
                        M.label.addClass("md-placeholder md-static"))
                    : (C.removeClass("md-select-placeholder"),
                ...
                T ||
                  s
                    .on("focus", function (e) {
                      M &&
                        M.element.hasClass("md-input-has-value") &&
                        M.setFocused(!0);
                    })
                    .on("blur", function (e) {
                      M && M.setFocused(!1), f();
              ...
              l.$observe("ngMultiple", function (e) {
                ...
                l.$observe("disabled", function (e) {
                  t.isString(e) && (e = !0),
                    (v === n || v !== e) &&
                      ((v = e),
                      e
                        ? (s.attr({ tabindex: -1, "aria-disabled": "true" }),
                          s.off("click", E),
                          s.off("keydown", b))
                        : (s.attr({
                            tabindex: l.tabindex,
                ...
                l.disabled ||
                  l.ngDisabled ||
                  (s.attr({ tabindex: l.tabindex, "aria-disabled": "false" }),
                  s.on("click", E),
                  s.on("keydown", b));
            ...
            (l.isMultiple = e),
              ...
              l.isMultiple
                ? ((o.$validators["md-multiple"] = n),
                  (o.$render = d),
                  r.$watchCollection(i.ngModel, function (e) {
          ...
          (l.optNodeForKeyboardSearch = function (e) {
            ...
            (l.init = function (n) {
              if (((l.ngModel = n), n.$options && n.$options.trackBy)) {
                ...
                l.hashGetter = function (e) {
                  return t.isObject(e)
                    ? "object_" + (e.$$mdSelectId || (e.$$mdSelectId = ++c))
                    : e;
                };
              l.setMultiple(l.isMultiple);
            }),
            (l.selectedLabels = function () {
              var e = o.nodesToArray(
            ...
            (l.refreshViewValue = function () {
              ...
              for (var n in l.selected)
                (e = l.options[n]) ? t.push(e.value) : t.push(l.selected[n]);
                ...
                t.isDefined(e) &&
                  ...
                  e
                    ? (l.isMultiple || l.deselect(Object.keys(l.selected)[0]),
                      l.select(s.hashKey, s.value))
                    : l.deselect(s.hashKey),
                  l.refreshViewValue(),
                  l.ngModel.$render());
              });
            }),
      ...
      function a(e) {
        function o(e, o, c, s, l, m, u, h) {
          ...
          function f(r, i, a) {
            function d(e, t, n) {
              return (
                ...
                l(function (e, n) {
                  try {
                    u(t, { removeClass: "md-leave", duration: 0 })
                      .start()
                      .then(p)
                      .then(e);
                  } catch (o) {
            ...
            function p() {
              return l(function (e) {
                ...
                var t = v(r, i, a);
                t.container.element.css($.toCss(t.container.styles)),
                  t.dropDown.element.css($.toCss(t.dropDown.styles)),
                  m(function () {
                    i.addClass("md-active"),
                      t.dropDown.element.css($.toCss({ transform: "" })),
                      b(a.focusedNode),
                      e();
                  });
              });
            ...
            function f(e, t, n) {
              return (
                n.disableParentScroll && !c.getClosest(n.target, "MD-DIALOG")
                  ? (n.restoreScroll = c.disableScrollAround(
                      n.element,
                      n.parent,
                    ))
                ...
                n.hasBackdrop &&
                  ...
                  h.enter(n.backdrop, n.parent, null, { duration: 0 })),
                function () {
            ...
            function C() {
              ...
              function r(t) {
                ...
                switch (t.keyCode) {
                  ...
                  case n.ENTER:
                    ...
                    r &&
                      (u.triggerHandler({ type: "click", target: r }),
                      t.preventDefault()),
                      m(t);
                    break;
                  case n.TAB:
              ...
              function d(e) {
                var t,
                  o = c.nodesToArray(a.optionNodes),
                ...
                function n() {
                  ...
                  if (t && t.currentTarget.children.length > 0) {
                    ...
                    if (o && n.children.length > 0) {
                      var r =
                        t.pageX - t.currentTarget.getBoundingClientRect().left;
                      r > n.querySelector("md-option").offsetWidth && (e = !0);
                    }
                  }
                  return e;
                }
                (t && "mouseup" == t.type && t.currentTarget != u[0]) ||
                  n() ||
                  h.isMultiple ||
                  ((a.restoreFocus = !0),
                  c.nextTick(function () {
            ...
            return (
              ...
              E(r, a),
              g(a.target),
              (a.hideBackdrop = f(r, i, a)),
              d(r, i, a).then(function (e) {
                return (
                  (a.alreadyOpen = !0),
                  (a.cleanupInteraction = C()),
                  (a.cleanupResizing = y()),
                  e
                );
              }, a.hideBackdrop)
          ...
          function g(e, n) {
            (n = t.isUndefined(n) ? "true" : "false"),
              e && e.attr("aria-expanded", n);
          }
          function b(e) {
              ...
              : C
                ...
                : T.length
                  ...
                  : l.length
                    ? l[0]
                    : g.firstElementChild || g),
              g.offsetWidth > y && (g.style["max-width"] = y + "px"),
              v && (g.style["min-width"] = E.width + "px"),
              A && f.classList.add("md-overflow");
            var w = m;
            "MD-OPTGROUP" === (w.tagName || "").toUpperCase() &&
              ((w = l[0] || g.firstElementChild || g), (m = w)),
              (o.focusedNode = w);
            var x = f.getBoundingClientRect(),
              N = a(m);
            if (m) {
              var _ = s.getComputedStyle(m);
              (N.paddingLeft = parseInt(_.paddingLeft, 10) || 0),
                (N.paddingRight = parseInt(_.paddingRight, 10) || 0);
            }
            if (A) {
              var H = g.offsetHeight / 2;
              (g.scrollTop = N.top + N.height / 2 - H),
                $.top < H
                  ? (g.scrollTop = Math.min(N.top, g.scrollTop + H - $.top))
                  : $.bottom < H &&
                    (g.scrollTop = Math.max(
                      N.top + N.height - x.height,
                      g.scrollTop - H + $.bottom,
                    ));
            }
            var S, D, O, I;
            v
              ? ((S = E.left),
                ...
                (O = "50% 0"),
                D + x.height > M.bottom &&
                  ((D = E.top - x.height), (O = "50% 100%")))
              : ((S = E.left + N.left - N.paddingLeft + 2),
                (D =
                  Math.floor(
                    E.top + E.height / 2 - N.height / 2 - N.top + g.scrollTop,
                  ) + 2),
                (O =
                  N.left +
                  E.width / 2 +
                  "px " +
                  (N.top + N.height / 2 - g.scrollTop) +
                  "px 0px"),
                (I = E.width + N.paddingLeft + N.paddingRight));
        ...
        function u(d, u, h, p) {
          ...
          function g(e) {
            var t =
              ...
              n = u.parent();
            return (
              n[e ? "on" : "off"]("keydown", v),
              k[e ? "on" : "off"]("click", M),
              e && (y = m[0].activeElement),
              b(e),
              (A = l
                .all([
                  e ? a.enter(k, n) : a.leave(k),
          ...
          function b(e) {
            var o = u.parent();
            e && !$
              ? (($ = o.css("overflow")), o.css("overflow", "hidden"))
              : t.isDefined($) && (o.css("overflow", $), ($ = n));
          }
          function E(e) {
            return d.isOpen == e
              ? l.when(!0)
    ...
    (function () {
      function e(e, n, o, r, i, a, d, c, s) {
        ...
        function m(o, l, m, u) {
          ...
          function N(e) {
            P() ||
              ((ee = !0), e.stopPropagation(), l.addClass("md-dragging"), S(e));
          }
          function _(e) {
          ...
          var F = t.element(l[0].querySelector(".md-thumb")),
            ...
            V = r.throttle(v, 5e3);
          t.isDefined(m.min) ? m.$observe("min", p) : p(0),
      ...
      function e(e, o, r, i) {
        function a(e) {
          ...
          function a() {
            ...
            for (
              var e, t = h.prop("scrollTop"), n = f.items.length - 1;
              n >= 0;
              n--
            )
              if (t > f.items[n].top) {
        ...
        function c(e) {
          function t() {
            +i.now() - o > a
              ...
              : (e.triggerHandler("$scroll"), r.throttle(t));
          }
          var n,
            o,
            a = 200;
          e.on("scroll touchmove", function () {
            n || ((n = !0), r.throttle(t), e.triggerHandler("$scrollstart")),
    ...
    (function () {
      function e(e, n, o, r) {
        return {
          ...
          transclude: !0,
          template:
            '<div class="md-subheader">  <div class="md-subheader-inner">    <span class="md-subheader-content"></span>  </div></div>',
          ...
          return (
            ...
            function (e, d, c, l) {
              ...
              i(function () {
                ...
                s(e, d, c, l),
                f &&
                  e.$watch(f, function (e) {
                    d.attr("tabindex", e ? -1 : 0);
                  }),
                a.register(b, "drag"),
                b.on("$md.dragstart", m).on("$md.drag", u).on("$md.dragend", h);
              var E;
            }
          );
        }
      ...
      function n(e) {
        function t(e, t, o) {
          function r(r, i, c) {
            return (
              (n = c.content),
              (i = o.extractElementByName(i, "md-toast", !0)),
              (c.onSwipe = function (e, n) {
                i.addClass("md-" + e.type.replace("$md.", "")),
                  o.nextTick(t.cancel);
              }),
              (c.openClass = a(c.position)),
              c.parent.addClass(c.openClass),
              i.on(d, c.onSwipe),
              i.addClass(
                c.position
                  .split(" ")
          ...
          function i(t, n, o) {
            return (
              n.off(d, o.onSwipe),
              o.parent.removeClass(o.openClass),
              1 == o.$destroy ? n.remove() : e.leave(n)
            );
          }
          function a(e) {
            return (
        ...
        return {
          ...
          link: function (d, c, s) {
            function l() {
              ...
              function l(e, t) {
                t &&
                  c.parent()[0] === t.parent()[0] &&
                  (f && f.off("scroll", M), (f = t), (g = u()));
              }
              function m(e) {
                var t = e ? e.target.scrollTop : E;
                $(),
                  (b = Math.min(p / v, Math.max(0, b + t - E))),
                  c.css(n.CSS.TRANSFORM, a([-b * v])),
                  f.css(n.CSS.TRANSFORM, a([(p - b) * v])),
                  (E = t),
                  o.nextTick(function () {
                    var e = c.hasClass("md-whiteframe-z1");
                    e && !b
                      ? i.removeClass(c, "md-whiteframe-z1")
                      : !e && b && i.addClass(c, "md-whiteframe-z1");
                  });
              }
              function u() {
                return f
      ...
      function e(e, n, o, r, i, a, d, c, s) {
        function l(l, h, p) {
          ...
          function b() {
            w.attr("aria-label") ||
              w.text().trim() ||
              w.attr("aria-label", h.text().trim());
          }
          function E() {
            h.detach(), h.attr("role", "tooltip");
          }
          function v() {
            for (var e = h.parent(); $("pointer-events", "none", e); )
              e = e.parent();
            return e;
          }
          function M() {
          ...
          function y() {
            ...
            var d = function (e) {
                return "focus" === e.type && a
                  ? void (a = !1)
                  : (w.on("blur mouseleave touchend touchcancel", c),
                    void A(!0));
              },
              c = function () {
                var t = l.hasOwnProperty("autohide")
                  ? l.autohide
                  : p.hasOwnProperty("mdAutohide");
                (t || e || r[0].activeElement !== w[0]) &&
                  (w.off("blur mouseleave touchend touchcancel", c),
            ...
            w.on("mousedown", function () {
              ...
              w.on("focus mouseenter touchstart", d),
              t.element(n).on("resize", D);
          }
          function A(t) {
            (A.value = !!t),
              A.queued ||
          ...
          function C() {
            return (
              S.append(h),
              $("display", "none")
                ? ((l.visible = !1), void h.detach())
                : (k(),
                  void t.forEach([h, x, N], function (e) {
          ...
          function T() {
            ...
            t.forEach([h, x, N], function (t) {
              t.parent() &&
                t.hasClass("md-show") &&
                e.push(c.removeClass(t, "md-show"));
            }),
          ...
          function k() {
            ...
            _
              ? (a = t(a))
              : a.top > h.prop("offsetParent").scrollHeight - o.height - u &&
                (a = t(n("top"))),
              h.css({ top: a.top + "px", left: a.left + "px" }),
              e();
          }
          a(h);
          var w = v(),
    ...
    (function () {
      ...
      function o(e, n, o, r) {
        (this.$scope = n),
          ...
          (this.scroller = o[0].getElementsByClassName(
            "md-virtual-repeat-scroller",
          )[0]),
          (this.sizer = this.scroller.getElementsByClassName(
            "md-virtual-repeat-sizer",
          )[0]),
          (this.offsetter = this.scroller.getElementsByClassName(
            "md-virtual-repeat-offsetter",
          )[0]),
          e(t.bind(this, this.updateSize)),
          r.ngHide &&
            n.$watch(
              r.ngHide,
              t.bind(this, function (n) {
      ...
      t.module("material.components.virtualRepeat", ["material.core"])
        .directive("mdVirtualRepeatContainer", e)
        .directive("mdVirtualRepeat", r);
      var d = 1533917,
        c = 3;
      (o.$inject = ["$$rAF", "$scope", "$element", "$attrs"]),
        ...
        (o.prototype.setSize_ = function (e) {
          (this.size = e),
            (this.$element[0].style[this.isHorizontal() ? "width" : "height"] =
              e + "px");
        }),
        ...
        (o.prototype.autoShrink_ = function (e) {
          ...
          this.autoShrink &&
            t !== this.size &&
            (t < (this.originalSize || this.size)
              ? (this.originalSize || (this.originalSize = this.size),
                this.setSize_(t))
              : this.originalSize &&
                (this.setSize_(this.originalSize), (this.originalSize = null)));
        }),
        ...
        (i.prototype.virtualRepeatUpdate_ = function (e, n) {
          var o = e ? e.length : 0,
            r = !1;
          if (
            (o !== this.itemsLength && ((r = !0), (this.itemsLength = o)),
            this.items &&
              o < this.items.length &&
              0 !== this.container.getScrollOffset())
          )
            return (this.items = e), void this.container.resetScroll();
          if (
            ((this.items = e),
          ...
          var a,
            ...
            s = [];
          for (
            a = this.newStartIndex;
            a < this.newEndIndex && null == this.blocks[a];
            a++
          )
            (d = this.getBlock_(a)), this.updateBlock_(d, a), c.push(d);
          for (; null != this.blocks[a]; a++)
            this.updateBlock_(this.blocks[a], a);
          for (var l = a - 1; a < this.newEndIndex; a++)
            (d = this.getBlock_(a)), this.updateBlock_(d, a), s.push(d);
          c.length &&
        ...
        (i.prototype.updateBlock_ = function (e, t) {
          (this.blocks[t] = e),
            (e["new"] ||
              ...
              this.$scope.$root.$$phase || e.scope.$digest());
        }),
      ...
      function e(e, o, a, d, c, s, l, m, u, h) {
        ...
        function f() {
          function t() {
            var e = re.scrollContainer.getBoundingClientRect(),
              t = {};
            e.right > d.right - i && (t.left = n.right - e.width + "px"),
              re.$.scrollContainer.css(t);
          }
          ...
          c > s && d.height - n.bottom - i < r
            ? ((u.top = "auto"),
              (u.bottom = s + "px"),
              (u.maxHeight = Math.min(r, n.top - d.top - i) + "px"))
            : ((u.top = c + "px"),
              (u.bottom = "auto"),
              (u.maxHeight = Math.min(r, d.bottom - n.bottom - i) + "px")),
            re.$.scrollContainer.css(u),
            a.nextTick(t, !1);
        }
        function g() {
          re.$.root.length &&
            (c(re.$.scrollContainer),
            re.$.scrollContainer.detach(),
            re.$.root.append(re.$.scrollContainer),
            l.pin && l.pin(re.$.scrollContainer, m));
        }
        function b() {
        ...
        function E() {
          ...
          u.$observe("disabled", function (e) {
            ...
            e.$watch("searchText", n ? a.debounce(D, n) : D),
            e.$watch("selectedItem", w),
            t.element(s).on("resize", f),
            e.$on("$destroy", v);
        }
        function v() {
        ...
        function M() {
          (re = {
            main: o[0],
            scrollContainer: o[0].getElementsByClassName(
              "md-virtual-repeat-container",
            )[0],
            scroller: o[0].getElementsByClassName(
              "md-virtual-repeat-scroller",
            )[0],
            ul: o.find("ul")[0],
            ...
            (re.li = re.ul.getElementsByTagName("li")),
            (re.snap = $()),
            (re.$ = y(re));
        }
        function $() {
        ...
        function D(t, n) {
          (te.index = B()),
            t !== n &&
              P(e.selectedItem).then(function (o) {
                t !== o &&
                  ((e.selectedItem = null),
                  t !== n && N(),
                  z()
        ...
        function R(e) {
          switch (e.keyCode) {
            case d.KEY_CODE.DOWN_ARROW:
              ...
              e.stopPropagation(),
                e.preventDefault(),
                (te.index = Math.min(te.index + 1, te.matches.length - 1)),
                X(),
                K();
              break;
        ...
        function Z() {
          return (
            ...
            te.scope.searchText &&
            ce &&
            !te.scope.selectedItem
          );
        }
        function J() {
          var t = e.searchText,
            n = t.toLowerCase();
          !e.noCache && ie[n] ? ((te.matches = ie[n]), K()) : Y(t),
            ce && (te.hidden = U());
        }
        function ee() {
          var t = e.searchText,
        ...
        return (
          ...
          (te.listLeave = T),
          (te.mouseUp = k),
          (te.getCurrentDisplayValue = q),
          (te.registerSelectedItemWatcher = H),
          (te.unregisterSelectedItemWatcher = S),
          (te.notFoundVisible = Z),
          p()
        );
      }
        ...
        return {
          ...
          template: function (e, t) {
            ...
            var i = o(),
              ...
              d = e.html();
            return (
              '        <md-autocomplete-wrap            layout="row"            ng-class="{ \'md-whiteframe-z1\': !floatingLabel, \'md-menu-showing\': !$mdAutocompleteCtrl.hidden }"            role="listbox">          ' +
              r() +
      ...
      function e(e, t) {
        function n(n, o, r) {
          ...
          i("$index", "$index"),
            i("item", c),
            e(o.contents())(d),
            r.hasOwnProperty("mdAutocompleteReplace") &&
              (o.after(o.contents()), o.remove());
        }
    ...
    (function () {
      function e(e, t, a, d, c) {
        function s(n, o) {
          ...
          var s = r("md-chips>*[md-chip-remove]") || m.remove,
            ...
            h = i.find("md-chip");
          return (
            i[0].querySelector("md-chip-template>*[md-chip-remove]") &&
              d.warn(
            ...
            function (n, r, i, d) {
              ...
              var p = d[0];
              if (
                ((p.chipContentsTemplate = l),
                (p.chipRemoveTemplate = s),
                (p.chipInputTemplate = u),
                r
                ...
                o.ngModel &&
                  (p.configureNgModel(r.controller("ngModel")),
                  i.mdOnAppend && p.useOnAppendExpression(),
                  i.mdOnRemove && p.useOnRemoveExpression(),
                  i.mdOnSelect && p.useOnSelectExpression(),
                  u != m.input &&
                    n.$watch("$mdChipsCtrl.readonly", function (e) {
                      e ||
                        t.nextTick(function () {
                          0 === u.indexOf("<md-autocomplete") &&
                            p.configureAutocomplete(
                              r
                                .find("md-autocomplete")
                                .controller("mdAutocomplete"),
                            ),
                            p.configureUserInput(r.find("input"));
                        });
                    })),
                h.length > 0)
              ) {
      ...
      var n =
          '      <md-chips-wrap          ng-if="!$mdChipsCtrl.readonly || $mdChipsCtrl.items.length > 0"          ng-keydown="$mdChipsCtrl.chipKeydown($event)"          ng-class="{ \'md-focused\': $mdChipsCtrl.hasFocus(), \'md-readonly\': !$mdChipsCtrl.ngModelCtrl }"          class="md-chips">        <md-chip ng-repeat="$chip in $mdChipsCtrl.items"            index="{{$index}}"            ng-class="{\'md-focused\': $mdChipsCtrl.selectedChip == $index, \'md-readonly\': $mdChipsCtrl.readonly}">          <div class="md-chip-content"              tabindex="-1"              aria-hidden="true"              ng-focus="!$mdChipsCtrl.readonly && $mdChipsCtrl.selectChip($index)"              md-chip-transclude="$mdChipsCtrl.chipContentsTemplate"></div>          <div ng-if="!$mdChipsCtrl.readonly"               class="md-chip-remove-container"               md-chip-transclude="$mdChipsCtrl.chipRemoveTemplate"></div>        </md-chip>        <div ng-if="!$mdChipsCtrl.readonly && $mdChipsCtrl.ngModelCtrl"            class="md-chip-input-container"            md-chip-transclude="$mdChipsCtrl.chipInputTemplate"></div>        </div>      </md-chips-wrap>',
        o =
      ...
      function e(e, t, n) {
        function o(o, r, i) {
          ...
          function d() {
            ...
            o.svgIcon ||
              o.svgSrc ||
              (o.fontIcon && r.addClass("md-font " + o.fontIcon),
              o.fontSet && r.addClass(e.fontSet(o.fontSet)),
              t() && r.addClass(e.fontSet()));
          }
          t(r), d();
          ...
          i["aria-label"] ||
            ("" == c || a()
              ? r.text() || n.expect(r, "aria-hidden", "true")
              : (n.expect(r, "aria-label", c), n.expect(r, "role", "img"))),
            s &&
              i.$observe(s, function (t) {
                r.empty(),
                  t &&
                    e(t).then(function (e) {
                      r.append(e);
    ...
    (function () {
      ...
      function o(e, n, o, r, i) {
        ...
        function d(n) {
          ...
          var r = n;
          return (
            t.forEach(e.fontSets, function (e) {
      ...
      function e(e, o, r, i, a, d) {
        ...
        (this.nestLevel = parseInt(o.mdNestLevel, 10) || 0),
          (this.init = function (e, t) {
            (t = t || {}),
              (c = e),
              (s = r[0].querySelector("[ng-click],[ng-mouseenter]")),
              (this.isInMenuBar = t.isInMenuBar),
              (this.nestedMenus = a.nodesToArray(
                c[0].querySelectorAll(".md-nested-menu"),
              )),
              this.enableHoverListener(),
              c.on("$mdInterimElementRemove", function () {
                l.isOpen = !1;
              });
          }),
          (this.enableHoverListener = function () {
            i.$on("$mdMenuOpen", function (e, t) {
              c[0].contains(t[0]) &&
                ((l.currentlyOpenMenu = t.controller("mdMenu")),
                (l.isAlreadyOpening = !1),
                l.currentlyOpenMenu.registerContainerProxy(
                  l.triggerContainerProxy.bind(l),
                ));
            }),
            ...
            var e,
              o = t.element(
                a.nodesToArray(c[0].querySelectorAll("md-menu-item")),
              );
            o.on("mouseenter", function (n) {
              if (!l.isAlreadyOpening) {
                var o =
                  n.target.querySelector("md-menu") ||
                  a.getClosest(n.target, "MD-MENU");
                e = d(
                  function () {
                    if (
                      (o && (o = t.element(o).controller("mdMenu")),
                      l.currentlyOpenMenu && l.currentlyOpenMenu != o)
                    ) {
                      var e = l.nestLevel + 1;
          ...
          (this.close = function (n, o) {
            if (
              l.isOpen &&
              ((l.isOpen = !1), i.$emit("$mdMenuClose", r), e.hide(null, o), !n)
            ) {
    ...
    (function () {
      function e(e) {
        function o(n) {
          ...
          var o = n.children()[0];
          if (
            (o.hasAttribute("ng-click") ||
              (o = o.querySelector("[ng-click],[ng-mouseenter]") || o),
            !o ||
          ...
          return (
            a &&
              t.forEach(e.nodesToArray(a), function (e) {
        ...
        function r(e, o, r, i) {
          var a = i[0],
            ...
            s = o.children()[1];
          c.append(s),
            d && (o.append(c), (c[0].style.display = "none")),
            a.init(c, { isInMenuBar: d }),
            e.$on("$destroy", function () {
      ...
      function e(e) {
        function o(e, o, a, d, c, s, l, m, u) {
          function h(n, o, r) {
            return r.nestLevel
              ? t.noop
              : (r.disableParentScroll && !e.getClosest(r.target, "MD-DIALOG")
                  ? (r.restoreScroll = e.disableScrollAround(
                      r.element,
                      r.parent,
                    ))
                  : (r.disableParentScroll = !1),
                r.hasBackdrop &&
                  ((r.backdrop = e.createBackdrop(
                    n,
                    "md-menu-backdrop md-click-catcher",
                  )),
                  u.enter(r.backdrop, r.parent)),
                function () {
          ...
          function f(n, r, i) {
            ...
            function f() {
              function t(t) {
                ...
                switch (t.keyCode) {
                  case a.KEY_CODE.ESCAPE:
                    ...
                    break;
                  case a.KEY_CODE.UP_ARROW:
                    g(t, i.menuContentEl, i, -1) ||
                      i.mdMenuCtrl.triggerContainerProxy(t),
                      (n = !0);
                    break;
                  case a.KEY_CODE.DOWN_ARROW:
                    g(t, i.menuContentEl, i, 1) ||
              ...
              var c = i.menuContentEl[0].querySelector(
                "[md-menu-focus-target]",
              );
              if (!c && s) {
          ...
          function b(e) {
            return e && -1 != e.getAttribute("tabindex")
              ? (e.focus(), d[0].activeElement == e)
              : void 0;
          }
          function E(e, t) {
            t.preserveElement
              ? (r(e).style.display = "none")
              : r(e).parentNode === r(t.parent) &&
                r(t.parent).removeChild(r(e));
          }
          function v(t, o) {
            function r(e) {
              (e.top = Math.max(
                Math.min(e.top, E.bottom - l.offsetHeight),
                E.top,
              )),
                (e.left = Math.max(
                  Math.min(e.left, E.right - l.offsetWidth),
                  E.left,
                ));
            }
            function a() {
      ...
      (e.$inject = [
        ...
        (e.prototype.init = function () {
          ...
          e.on("keydown", this.handleKeyDown),
            (this.parentToolbar = o.getClosest(e, "MD-TOOLBAR")),
            r.$on("$mdMenuOpen", function (t, n) {
              -1 != i.getMenus().indexOf(n[0]) &&
            ...
            r.$on("$mdMenuClose", function (t, r) {
              ...
              if (
                ...
                for (var d = r[0]; d && -1 == a.indexOf(d); )
                  d = o.getClosest(d, "MD-MENU", !0);
                d &&
        ...
        (e.prototype.disableOpenOnHover = function () {
          if (this.openOnHoverEnabled) {
            ...
            var e;
            (e = this.parentToolbar) &&
              e.setAttribute("style", e.dataset.mdRestoreStyle || "");
          }
        }),
        ...
        (e.prototype.focusMenu = function (e) {
          ...
          return (
            -1 == n
              ? (n = 0)
              : ((0 > e && n > 0) || (e > 0 && n < t.length - e)) &&
                ((n += e), (o = !0)),
            o ? (t[n].querySelector("button").focus(), t[n]) : void 0
          );
        }),
        ...
        (e.prototype.getFocusedMenuIndex = function () {
          var e = this.$mdUtil,
            t =
              (this.$element,
              e.getClosest(this.$document[0].activeElement, "MD-MENU"));
          if (!t) return -1;
      ...
      t
        ...
        (e.prototype.initClickListeners = function () {
          ...
          var c = this.iconEl,
            ...
            l = this.handleClick;
          i.$observe("disabled", n),
            n(i.disabled),
            (o.$render = function () {
              e()
                ? ((c.style.display = ""), a.attr("aria-checked", "true"))
                : ((c.style.display = "none"), a.attr("aria-checked", "false"));
            }),
        ...
        (e.prototype.handleClick = function (e) {
          ...
          "checkbox" == n
            ? (t = !o.$modelValue)
            : "radio" == n &&
              (t = r.ngValue ? this.$scope.$eval(r.ngValue) : r.value),
            o.$setViewValue(t),
            o.$render();
        });
    })(),
          ...
          compile: function (e, n) {
            ...
            if ("checkbox" == n.type || "radio" == n.type) {
              ...
              a.html(i),
                ...
                o(
                  "role",
                  "checkbox" == n.type ? "menuitemcheckbox" : "menuitemradio",
                ),
          ...
          compile: function (n, o) {
            ...
            if (
              (0 == r.length &&
                ...
                o.label ? r.text(o.label) : r.append(n.contents())),
              0 == i.length)
            ) {
    ...
    (function () {
      function e(e, n, o, r, i, a, d, c, s, l) {
        function m() {
          (ae.selectedIndex = ae.selectedIndex || 0),
            u(),
            p(),
            h(),
            l(n),
            a.nextTick(function () {
              te(),
                Q(),
                ne(),
                ae.tabs[ae.selectedIndex] &&
                  ae.tabs[ae.selectedIndex].scope.select(),
                (me = !0),
                W();
            });
        }
        ...
        function A(n) {
          ...
          t
            .element(ce.paging)
            .css(r.CSS.TRANSFORM, "translate3d(" + o + ", 0, 0)"),
        ...
        function T(t, n) {
          t !== n &&
            ((ae.selectedIndex = j(t)),
            (ae.lastSelectedIndex = n),
            ae.updateInkBarStyles(),
            te(),
            Q(t),
            e.$broadcast("$mdTabsChanged"),
            ae.tabs[n] && ae.tabs[n].scope.deselect(),
            ae.tabs[t] && ae.tabs[t].scope.select());
        }
        function k(e) {
        ...
        function N(e) {
          de || (ae.focusIndex = ae.selectedIndex = e),
            (ae.lastClick = !0),
            a.nextTick(function () {
        ...
        function _(e) {
          ae.shouldPaginate &&
            (e.preventDefault(),
            (ae.offsetLeft = re(ae.offsetLeft - e.wheelDelta)));
        }
        function H() {
          var e,
            t,
            n = ce.canvas.clientWidth,
            o = n + ae.offsetLeft;
          for (
            e = 0;
            e < ce.tabs.length &&
            ((t = ce.tabs[e]), !(t.offsetLeft + t.offsetWidth > o));
            e++
          );
        ...
        function S() {
          ...
          for (
            ...
            e < ce.tabs.length &&
            ((t = ce.tabs[e]),
            !(t.offsetLeft + t.offsetWidth >= ae.offsetLeft));
            e++
          );
          ae.offsetLeft = re(
            t.offsetLeft + t.offsetWidth - ce.canvas.clientWidth,
          );
        }
        function D() {
          (ae.lastSelectedIndex = ae.selectedIndex),
            (ae.offsetLeft = re(ae.offsetLeft)),
            a.nextTick(function () {
        ...
        function L(e, n) {
          var o = me,
            ...
            i = t.extend(r, e);
          return (
            t.isDefined(n) ? ae.tabs.splice(n, 0, i) : ae.tabs.push(i),
            Z(),
            J(),
            a.nextTick(function () {
              W(),
        ...
        function P() {
          ...
          return (
            ...
            (e.data = n[0].getElementsByTagName("md-tab-data")[0]),
            ...
            (e.contents =
              e.contentsWrapper.getElementsByTagName("md-tab-content")),
            e
          );
        }
        function F() {
        ...
        function B() {
          ...
          return (
            e &&
            e.offsetLeft + e.offsetWidth > ce.canvas.clientWidth + ae.offsetLeft
          );
        }
        function U() {
          switch (ae.stretchTabs) {
            ...
            default:
              return (
                !ae.shouldPaginate && o.matchMedia("(max-width: 600px)").matches
              );
          }
        }
        function q() {
        ...
        function z() {
          ...
          return (
            t.forEach(ce.dummies, function (t) {
              e -= t.offsetWidth;
            }),
            0 > e
          );
        ...
        function j(e) {
          ...
          var t,
            n,
            o = Math.max(ae.tabs.length - e, e);
          for (t = 0; o >= t; t++) {
            if (((n = ae.tabs[e + t]), n && n.scope.disabled !== !0))
              return n.getIndex();
            if (((n = ae.tabs[e - t]), n && n.scope.disabled !== !0))
              return n.getIndex();
          }
        ...
        function K() {
          ...
          (ae.tabs = ae.tabs.sort(function (e, t) {
            ...
            (ae.selectedIndex = ae.tabs.indexOf(e)),
            (ae.focusIndex = ae.tabs.indexOf(t));
        }
        function G(e, t) {
          var n,
        ...
        function Q(e) {
          if (
            (null == e && (e = ae.focusIndex),
            ce.tabs[e] && !ae.shouldCenterTabs)
          ) {
            var t = ce.tabs[e],
              n = t.offsetLeft,
              o = t.offsetWidth + n;
            (ae.offsetLeft = Math.max(
              ae.offsetLeft,
              re(o - ce.canvas.clientWidth + 64),
            )),
              (ae.offsetLeft = Math.min(ae.offsetLeft, re(n)));
          }
        }
        function Z() {
        ...
        function ee() {
          (ae.selectedIndex = j(ae.selectedIndex)),
            (ae.focusIndex = j(ae.focusIndex));
        }
        function te() {
        ...
        function ne() {
          ...
          var e,
            ...
            c = r - d - i.offsetWidth;
          ae.shouldCenterTabs &&
            ((e = Array.prototype.slice.call(ce.tabs).reduce(function (e, t) {
              return e + t.offsetWidth;
            }, 0)),
            r > e && a.nextTick(ne, !1)),
            oe(),
            t.element(ce.inkBar).css({ left: d + "px", right: c + "px" });
        }
        function oe() {
          ...
          t.isNumber(n) &&
            o.toggleClass("md-left", n > e).toggleClass("md-right", e > n);
        }
        function re(e) {
          ...
          return (
            (e = Math.max(0, e)), (e = Math.min(n - ce.canvas.clientWidth, e))
          );
        }
        function ie(e, n) {
        ...
        var ae = this,
          ...
          me = !1;
        f("stretchTabs", E),
          V("focusIndex", C, ae.selectedIndex || 0),
          V("offsetLeft", A, 0),
          V("hasContent", y, !1),
          V("maxTabWidth", M, Y()),
          V("shouldPaginate", $, !1),
          ...
          (ae.parent = e.$parent),
          (ae.tabs = []),
          (ae.lastSelectedIndex = null),
          (ae.hasFocus = !1),
          (ae.lastClick = !0),
          (ae.shouldCenterTabs = q()),
          (ae.updatePagination = a.debounce(W, 100)),
          (ae.redirectFocus = X),
          (ae.attachRipple = ie),
          (ae.insertTab = L),
          (ae.removeTab = R),
          ...
          (ae.refreshIndex = ee),
          (ae.incrementIndex = G),
          (ae.getTabElementIndex = k),
          (ae.updateInkBarStyles = a.debounce(ne, 100)),
          (ae.updateTabOrder = a.debounce(K, 100)),
          m();
      }
