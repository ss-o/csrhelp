(function () {
  ...
  function CsrhelpController(
    ...
    var ECCKeySizes = [
      { key: 256, value: "secp256r1" },
      { key: 384, value: "secp384r1" },
      { key: 521, value: "secp521r1" },
    ];
      ...
      $($event.currentTarget)
        .attr(
          ...
          "data:application/pkcs8," +
            encodeURIComponent($scope.messages[6].privateKey),
        )
      ...
      if ($scope.certificateForm.$valid) {
        ...
        if (master.cachedMessages[md5Key]) {
          ...
          $scope.messages.forEach(function (message) {
            var context = csrhelpService[message.method].call(
              null,
              certf,
              message,
            );
